...
class HeightField {
  ...
  //! return the diffuse-color for the ground in wireframe and flat-shading rendering modes
    cs237::color3f const &DiffuseC () const { return this->_color; }

  //! return the diffuse-color map image for the ground
    cs237::image2d *DiffuseMap () const { return this->_colorMap; }
