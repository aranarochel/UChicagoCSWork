...
class Camera {
  ...
  //! the camera's current up vector
    ...
    void setUp(cs237::vec3f up) { this->_up = up;}
  ...
  //! a transformation matrix that assumes that the camera is at the origin.
    ...
    cs237::mat4x4f viewTransform (cs237::vec3d pos) const;
    cs237::mat4x4f viewTransform (cs237::vec3d pos, cs237::vec3f dir) const;
  ...
  //! change the direction of the camera
    ...
    void look (cs237::vec4f const &dir);
