...
class Cell {
  ...
  //! the row of this cell in the grid of cells in the map
    ...
    void setRow(int newRow) {this->_row = newRow;}
  //! the column of this cell in the grid of cells in the map
    int Col () const { return this->_col; }
    void setCol(int newCol) {this->_col = newCol;}
    void setRowCol(int row, int col) {this-> _row = row; this->_col = col;}
...
class Tile {
  ...
  // dump the tile tree to an output stream
    ...
    cs237::mat4x4f modelMat;

    //caching
    int isVisible;
    struct VAO *tileVAO;
    int renderDepth;
    cs237::mat4x4f modelViewMat;
  private:
